...
class Purchase{
      ...
      private $logic;
        ...
        public function getFulfillmentReports($REQUEST){
            extract($REQUEST);
            $statement = "Call getFulfillmentReports('$token','$brand','$fromDate','$toDate','$delivery_state','$sales_channel','$sortby','$sortkey','$page','$pagesize')";
            //echo $statement;
            //exit;  
            $this->logic->p_list($REQUEST,$statement,'');
        }
    ...
    public function getDetails($REQUEST){
        ...
        public function getDropDowns(){
            ...
            $data['channel_ids'] = $stmt->fetchAll(PDO::FETCH_ASSOC);
			$stmt->nextRowset();
                  }
